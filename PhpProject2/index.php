	...
	<head>
		...
		<body>
					...
					<div class="header-wrap">
						<div class="header-top d-flex justify-content-between align-items-center">
							...
							<div class="main-menubar d-flex align-items-center">
								<nav class="hide">
									<a href="#home">Home</a>
									<a href="#registerAndLogin">Register/Login</a>
			...
			<section class="banner-area relative" id="home">
			   ...
			   <!--Start register/login form area-->
			   <section class="about-area section-gap" id="registerAndLogin">
            <div class="container">
                <div class="login-box">
                    <div class="row">
                        <div class="col-md-6 login-left">
                            ...
                            <form action="validation.php" method="post">
                                ...
                                <button class="nw-btn primary-btn mt-25">Login<span class="lnr lnr-arrow-right"></span></button>
                            </form>
                        </div>
                        <div class="col-md-6" login-right >
                            ...
                            <form action="registeration.php" method="post">
                                ...
                                <button class="nw-btn primary-btn mt-25">Register<span class="lnr lnr-arrow-right"></span></button>
                            </form>
                        </div>
                    </div>
                </div>
				...
				<div class="container">
					...
					<div class="row">
						...
						<a href="blogpost1.html">
							...
							<h4>
								<a href="blogpost1.html">THE EVERY-PERSON’S GUIDE TO IMMUNE SYSTEM SUPPORT</a>
							</h4>
							<p>
						...
						<a href="blogpost2.html">
							...
							<h4>
								<a href="blogpost2.html">4 EASY WAYS TO LOSE WEIGHT</a>
							</h4>
							<p>
						...
						<a href="blogpost3.html">
							...
							<h4>
								<a href="blogpost3.html">THE MEAL TIMING MYTH?</a>
							</h4>
							<p>
					...
					<div class="row">
						<div class="col-lg-2  col-md-6">
							<div class="single-footer-widget">
								<h6>Navigate</h6>
								<ul class="footer-nav">
									<li><a href="#registerAndLogin">Register/Login</a></li>
									<li><a href="#blog">Blog</a></li>
									<li><a href="#consultant">Our Team</a></li>
								</ul>
							</div>
						</div>
